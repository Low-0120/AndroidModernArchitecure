...
import com.example.modern_architecture_template.configurePrintApksTask
import com.example.modern_architecture_template.disableUnnecessaryAndroidTests
    ...
    override fun apply(target: Project) {
        with(target) {
            with(pluginManager) {
                ...
                apply("modernarchitercture.android.lint")
            }
